...
class Lottery5_Pro(unittest.TestCase):  # 五分彩 QAT/STG環境任選主玩法為關閉
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("SSC", "lottery5")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_Lottery5_pro_normal_fiveStar_fiveStarDirectSelection(self):
    ...
    def test_02_Lottery5_pro_normal_fiveStar_fiveStarOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_03_Lottery5_pro_normal_fiveStar_selection120(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_04_Lottery5_pro_normal_fiveStar_selection60(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_05_Lottery5_pro_normal_fiveStar_selection30(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_06_Lottery5_pro_normal_fiveStar_selection20(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_07_Lottery5_pro_normal_fiveStar_selection10(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_08_Lottery5_pro_normal_fiveStar_selection5(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_09_Lottery5_pro_normal_threeStar_front3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_10_Lottery5_pro_normal_threeStar_front3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_11_Lottery5_pro_normal_threeStar_middle3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_12_Lottery5_pro_normal_threeStar_middle3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_13_Lottery5_pro_normal_threeStar_back3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_14_Lottery5_pro_normal_threeStar_back3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_15_Lottery5_pro_normal_threeStar_front3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_16_Lottery5_pro_normal_threeStar_middle3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_17_Lottery5_pro_normal_threeStar_back3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_18_Lottery5_pro_normal_threeStarGroup3_front3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_19_Lottery5_pro_normal_threeStarGroup3_middle3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_20_Lottery5_pro_normal_threeStarGroup3_back3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_21_Lottery5_pro_normal_threeStarGroup6_front3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_22_Lottery5_pro_normal_threeStarGroup6_middle3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_23_Lottery5_pro_normal_threeStarGroup6_back3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_24_Lottery5_pro_normal_twoStar_frontDirect(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_25_Lottery5_pro_normal_twoStar_frontGroup(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_26_Lottery5_pro_normal_twoStar_frontOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_27_Lottery5_pro_normal_twoStar_backDirect(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_28_Lottery5_pro_normal_twoStar_backGroup(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_29_Lottery5_pro_normal_twoStar_backOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_30_Lottery5_pro_normal_dingweidan(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_31_Lottery5_pro_normal_budingweidan_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_32_Lottery5_pro_normal_budingweidan_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_33_Lottery5_pro_normal_budingweidan_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_34_Lottery5_pro_normal_bigSmallOddEven(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    # def test_35_Lottery5_pro_normal_freeSelection_twoDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_36_Lottery5_pro_normal_freeSelection_twoGroup(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_37_Lottery5_pro_normal_freeSelection_twoOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_38_Lottery5_pro_normal_freeSelection_threeDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_39_Lottery5_pro_normal_freeSelection_threeGroup3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_40_Lottery5_pro_normal_freeSelection_threeGroup6(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_41_Lottery5_pro_normal_freeSelection_threeOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_42_Lottery5_pro_normal_freeSelection_fourDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_43_Lottery5_pro_normal_freeSelection_fourOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
