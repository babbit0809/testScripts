...
class F2Racing_Pro(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("PK10", "f2racing")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_F2Racing_pro_normal_guess1(self):
    ...
    def test_02_F2Racing_pro_normal_guess12(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_03_F2Racing_pro_normal_guess123(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_04_F2Racing_pro_normal_firstToTenth(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_05_F2Racing_pro_fun_eat1(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_06_F2Racing_pro_fun_bet3(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_07_F2Racing_pro_fun_eat3(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_08_F2Racing_pro_fun_positionQ(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_09_F2Racing_pro_fun_winningStreak(self):
        page_pk10 = GamePagePK10(self.driver)
