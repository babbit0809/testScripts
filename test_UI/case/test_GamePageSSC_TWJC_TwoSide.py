...
class TWJC_TwoSide(unittest.TestCase):
    ...
    def test_35_TWJC_twoSide_firstBall(self):
    ...
    def test_36_TWJC_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_37_TWJC_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_38_TWJC_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_39_TWJC_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_40_TWJC_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_41_TWJC_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_42_TWJC_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_43_TWJC_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_44_TWJC_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_45_TWJC_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_TWJC_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
