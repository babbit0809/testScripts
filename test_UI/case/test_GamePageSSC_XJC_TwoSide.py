...
class XJC_TwoSide(unittest.TestCase):  # 新疆時時彩 QAT/STG環境任選主玩法為關閉
    ...
    def test_44_XJC_twoSide_firstBall(self):
    ...
    def test_45_XJC_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_XJC_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_XJC_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_XJC_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_XJC_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_50_XJC_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_51_XJC_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_XJC_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_XJC_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_XJC_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_XJC_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
