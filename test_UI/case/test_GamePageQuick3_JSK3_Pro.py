...
class JSK3_Pro(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("Quick3", "jsk3")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_JSK3_pro_normal_sum(self):
    ...
    def test_02_JSK3_pro_normal_continuous3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_03_JSK3_pro_normal_same3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_JSK3_pro_normal_differ3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_05_JSK3_pro_normal_same2_singleChoice(self):
        bet_case = (
    ...
    def test_06_JSK3_pro_normal_same2_multiChoices(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_07_JSK3_pro_normal_differ2(self):
        page_quick3 = GamePageQuick3(self.driver)
