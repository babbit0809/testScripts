...
class TWK3_TwoSide(unittest.TestCase):
    ...
    def test_08_TWK3_twoSide_army3(self):
    ...
    def test_09_TWK3_twoSide_fast3Sum(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_TWK3_twoSide_point(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_11_TWK3_twoSide_triple(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_12_TWK3_twoSide_long(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_13_TWK3_twoSide_short(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_14_TWK3_twoSide_fishShrimpCrab(self):
        page_quick3 = GamePageQuick3(self.driver)
