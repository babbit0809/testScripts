...
class Quick3_Pro(unittest.TestCase):
    ...
    def test_01_Quick3_pro_normal_sum(self):
    ...
    def test_02_Quick3_pro_normal_continuous3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_03_Quick3_pro_normal_same3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_Quick3_pro_normal_differ3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_05_Quick3_pro_normal_same2_singleChoice(self):
        bet_case = (
    ...
    def test_06_Quick3_pro_normal_same2_multiChoices(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_07_Quick3_pro_normal_differ2(self):
        page_quick3 = GamePageQuick3(self.driver)
