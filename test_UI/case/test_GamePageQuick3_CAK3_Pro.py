...
class CAK3_Pro(unittest.TestCase):
    ...
    def test_01_CAK3_pro_normal_sum(self):
    ...
    def test_02_CAK3_pro_normal_continuous3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_03_CAK3_pro_normal_same3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_CAK3_pro_normal_differ3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_05_CAK3_pro_normal_same2_singleChoice(self):
        bet_case = (
    ...
    def test_06_CAK3_pro_normal_same2_multiChoices(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_07_CAK3_pro_normal_differ2(self):
        page_quick3 = GamePageQuick3(self.driver)
