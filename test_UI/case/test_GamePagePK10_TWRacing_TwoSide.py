...
class TWRacing_TwoSide(unittest.TestCase):
    ...
    def test_10_TWRacing_twoSide_twoface(self):
    ...
    def test_11_TWRacing_twoSide_combination1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_12_TWRacing_twoSide_sum1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_13_TWRacing_twoSide_firsttotenth(self):
        page_pk10 = GamePagePK10(self.driver)
