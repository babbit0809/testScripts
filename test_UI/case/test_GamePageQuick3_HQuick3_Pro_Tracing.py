...
class HQuick3_Pro_Tracing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("Quick3", "hquick3")

    def test_01_HQuick3_pro_normal_continuous3_double_tracking(self):
    ...
    # def test_02_HQuick3_pro_normal_continuous3_smart_tracking(self):
    #     page_quick3 = GamePageQuick3(self.driver)
    #     page_quick3.switch_pro_game("normal", "continuous3")
    ...
    def test_03_HQuick3_pro_normal_same3_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    # def test_04_HQuick3_pro_normal_same3_smart_tracking(self):
    #     page_quick3 = GamePageQuick3(self.driver)
    #     page_quick3.switch_pro_game("normal", "same3")
    #     # page_quick3.bet_pro_all("same3")
    #
    ...
    def test_05_HQuick3_pro_normal_differ3_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    # def test_06_HQuick3_pro_normal_differ3_smart_tracking(self):
    #     page_quick3 = GamePageQuick3(self.driver)
    #     page_quick3.switch_pro_game("normal", "differ3")
    #     # page_quick3.bet_pro_all("differ3")
    #
    ...
    def test_07_HQuick3_pro_normal_same2_singleChoice_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    # def test_08_HQuick3_pro_normal_same2_singleChoice_smart_tracking(self):
    #     page_quick3 = GamePageQuick3(self.driver)
    #     page_quick3.switch_pro_game("normal", "same2", "singleChoice")
    #
    #     bet_flow = GamePageCommon(self.driver)
    ...
    def test_09_HQuick3_pro_normal_differ2_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_HQuick3_pro_normal_differ2_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "differ2")
        # page_quick3.bet_pro_all("differ2")
