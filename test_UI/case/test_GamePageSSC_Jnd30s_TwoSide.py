...
class Jnd30s_TwoSide(unittest.TestCase):
    ...
    def test_44_Jnd30s_twoSide_firstBall(self):
    ...
    def test_45_Jnd30s_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_Jnd30s_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_Jnd30s_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_Jnd30s_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_Jnd30s_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_50_Jnd30s_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_51_Jnd30s_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_Jnd30s_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_Jnd30s_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_Jnd30s_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_Jnd30s_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
