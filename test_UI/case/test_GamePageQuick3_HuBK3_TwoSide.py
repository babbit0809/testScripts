...
class HuBK3_TwoSide(unittest.TestCase):
    ...
    def test_08_HuBK3_twoSide_army3(self):
    ...
    def test_09_HuBK3_twoSide_fast3Sum(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_HuBK3_twoSide_point(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_11_HuBK3_twoSide_triple(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_12_HuBK3_twoSide_long(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_13_HuBK3_twoSide_short(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_14_HuBK3_twoSide_fishShrimpCrab(self):
        page_quick3 = GamePageQuick3(self.driver)
