...
class JSK3_TwoSide(unittest.TestCase):
    ...
    def test_08_JSK3_twoSide_army3(self):
    ...
    def test_09_JSK3_twoSide_fast3Sum(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_JSK3_twoSide_point(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_11_JSK3_twoSide_triple(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_12_JSK3_twoSide_long(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_13_JSK3_twoSide_short(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_14_JSK3_twoSide_fishShrimpCrab(self):
        page_quick3 = GamePageQuick3(self.driver)
