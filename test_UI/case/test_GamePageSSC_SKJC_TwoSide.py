...
class SKJC_TwoSide(unittest.TestCase):
    ...
    def test_44_SKJC_twoSide_firstBall(self):
    ...
    def test_45_SKJC_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_SKJC_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_SKJC_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_SKJC_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_SKJC_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_50_SKJC_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_51_SKJC_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_SKJC_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_SKJC_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_SKJC_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_SKJC_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
