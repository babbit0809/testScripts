...
class TXFFC_Pro(unittest.TestCase):  # 騰訊分分彩 QAT/STG環境無五星玩法且任選主玩法為關閉, 另子玩法開關狀況如下
    # 三星玩法(僅有後三直選/單式/混選)/三星組三(僅有後三組三)/三星組六(僅有後三組六)/二星玩法(僅有後二直選/組選/單式)/不定位膽(僅有後三)
    # 雙面盤的第一球/第二球/前三/中三為關閉
    @classmethod
    def setUpClass(cls):
        cls.driver = Driver
        ...
        cls.game_name = game_page.switch_game("SSC", "txffc")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    # def test_01_TXFFC_pro_normal_fiveStar_fiveStarDirectSelection(self):
    ...
    #
    # def test_02_TXFFC_pro_normal_fiveStar_fiveStarOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_03_TXFFC_pro_normal_fiveStar_selection120(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_04_TXFFC_pro_normal_fiveStar_selection60(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_05_TXFFC_pro_normal_fiveStar_selection30(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_06_TXFFC_pro_normal_fiveStar_selection20(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_07_TXFFC_pro_normal_fiveStar_selection10(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_08_TXFFC_pro_normal_fiveStar_selection5(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_09_TXFFC_pro_normal_threeStar_front3Choice(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_10_TXFFC_pro_normal_threeStar_front3Order(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_11_TXFFC_pro_normal_threeStar_middle3Choice(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_12_TXFFC_pro_normal_threeStar_middle3Order(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_13_TXFFC_pro_normal_threeStar_back3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_14_TXFFC_pro_normal_threeStar_back3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    # def test_15_TXFFC_pro_normal_threeStar_front3Mix(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_16_TXFFC_pro_normal_threeStar_middle3Mix(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_17_TXFFC_pro_normal_threeStar_back3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    # def test_18_TXFFC_pro_normal_threeStarGroup3_front3Group3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_19_TXFFC_pro_normal_threeStarGroup3_middle3Group3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_20_TXFFC_pro_normal_threeStarGroup3_back3Group3(self):  # 僅有一個子玩法, 無選項可選, 改為"None"
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "threeStarGroup3", "None")
    ...
    # def test_21_TXFFC_pro_normal_threeStarGroup6_front3Group6(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_22_TXFFC_pro_normal_threeStarGroup6_middle3Group6(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_23_TXFFC_pro_normal_threeStarGroup6_back3Group6(self):  # 僅有一個子玩法, 無選項可選, 改為"None"
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "threeStarGroup6", "None")
    ...
    # def test_24_TXFFC_pro_normal_twoStar_frontDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_25_TXFFC_pro_normal_twoStar_frontGroup(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_26_TXFFC_pro_normal_twoStar_frontOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_27_TXFFC_pro_normal_twoStar_backDirect(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_28_TXFFC_pro_normal_twoStar_backGroup(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_29_TXFFC_pro_normal_twoStar_backOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_30_TXFFC_pro_normal_dingweidan(self):  # 修正預期結果 base on Requirement 1820 騰訊分分彩玩法修正
        page_ssc = GamePageSSC(self.driver)
        ...
        expect_data = [self.game_name, "", "0.60", self.OrderInfoTrace_No, "1", "30"]
        Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)

    # def test_31_TXFFC_pro_normal_budingweidan_front3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_32_TXFFC_pro_normal_budingweidan_middle3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_33_TXFFC_pro_normal_budingweidan_back3(self):  # 僅有一個子玩法, 無選項可選, 改為"None"
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "budingweidan", "None")
    ...
    def test_34_TXFFC_pro_normal_bigSmallOddEven(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    # def test_35_TXFFC_pro_normal_freeSelection_twoDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_36_TXFFC_pro_normal_freeSelection_twoGroup(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_37_TXFFC_pro_normal_freeSelection_twoOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_38_TXFFC_pro_normal_freeSelection_threeDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_39_TXFFC_pro_normal_freeSelection_threeGroup3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_40_TXFFC_pro_normal_freeSelection_threeGroup6(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_41_TXFFC_pro_normal_freeSelection_threeOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_42_TXFFC_pro_normal_freeSelection_fourDirect(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    #     Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_43_TXFFC_pro_normal_freeSelection_fourOrder(self):
    #     page_ssc = GamePageSSC(self.driver)
