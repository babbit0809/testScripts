...
class F3Racing_TwoSide(unittest.TestCase):
    ...
    def test_10_F3Racing_twoSide_twoface(self):
    ...
    def test_11_F3Racing_twoSide_combination1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_12_F3Racing_twoSide_sum1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_13_F3Racing_twoSide_firsttotenth(self):
        page_pk10 = GamePagePK10(self.driver)
