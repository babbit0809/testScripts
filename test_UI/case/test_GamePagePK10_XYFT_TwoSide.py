...
class XYFT_TwoSide(unittest.TestCase):
    ...
    def test_10_XYFT_twoSide_twoface(self):
    ...
    def test_11_XYFT_twoSide_combination1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_12_XYFT_twoSide_sum1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_13_XYFT_twoSide_firsttotenth(self):
        page_pk10 = GamePagePK10(self.driver)
