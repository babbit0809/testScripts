...
class SKJC_Pro_Tracing(unittest.TestCase):
    ...
    def test_01_SKJC_pro_normal_fiveStar_fiveStarDirectSelection_double_tracking(self):
    ...
    def test_02_SKJC_pro_normal_fiveStar_fiveStarDirectSelection_smart_tracking(self):
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "fiveStar", "fiveStarDirectSelection")
    ...
    def test_03_SKJC_pro_normal_threeStar_front3Choice_double_tracking(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_04_SKJC_pro_normal_threeStar_front3Choice_smart_tracking(self):
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "threeStar", "front3Choice")
    ...
    def test_05_SKJC_pro_normal_twoStar_frontDirect_double_tracking(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_06_SKJC_pro_normal_twoStar_frontDirect_smart_tracking(self):
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "twoStar", "frontDirect")
    ...
    def test_07_SKJC_pro_normal_dingweidan_double_tracking(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_08_SKJC_pro_normal_dingweidan_smart_tracking(self):
        page_ssc = GamePageSSC(self.driver)
        page_ssc.switch_pro_game("normal", "dingweidan")
