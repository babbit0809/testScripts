...
class TW11x5_TwoSide(unittest.TestCase):
    ...
    def test_43_TW11x5_twoSide_firstBall(self):
    ...
    def test_44_TW11x5_twoSide_secondBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_45_TW11x5_twoSide_thirdBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_46_TW11x5_twoSide_fourthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_47_TW11x5_twoSide_fifthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_48_TW11x5_twoSide_total(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_49_TW11x5_twoSide_dragon(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_50_TW11x5_twoSide_tiger(self):
        page_11x5 = GamePage11x5(self.driver)
