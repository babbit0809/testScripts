...
class SD11x5_TwoSide(unittest.TestCase):
    ...
    def test_43_SD11x5_twoSide_firstBall(self):
    ...
    def test_44_SD11x5_twoSide_secondBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_45_SD11x5_twoSide_thirdBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_46_SD11x5_twoSide_fourthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_47_SD11x5_twoSide_fifthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_48_SD11x5_twoSide_total(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_49_SD11x5_twoSide_dragon(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_50_SD11x5_twoSide_tiger(self):
        page_11x5 = GamePage11x5(self.driver)
