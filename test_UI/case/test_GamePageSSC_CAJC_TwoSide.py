...
class CAJC_TwoSide(unittest.TestCase):
    ...
    def test_35_CAJC_twoSide_firstBall(self):
    ...
    def test_36_CAJC_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_37_CAJC_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_38_CAJC_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_39_CAJC_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_40_CAJC_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_41_CAJC_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_42_CAJC_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_43_CAJC_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_44_CAJC_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_45_CAJC_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_CAJC_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
