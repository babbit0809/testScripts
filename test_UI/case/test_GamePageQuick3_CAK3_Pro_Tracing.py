...
class CAK3_Pro_Tracing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("Quick3", "cak3")

    def test_01_CAK3_pro_normal_continuous3_double_tracking(self):
    ...
    def test_02_CAK3_pro_normal_continuous3_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "continuous3")
    ...
    def test_03_CAK3_pro_normal_same3_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_CAK3_pro_normal_same3_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "same3")
        # page_quick3.bet_pro_all("same3")
    ...
    def test_05_CAK3_pro_normal_differ3_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_06_CAK3_pro_normal_differ3_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "differ3")
        # page_quick3.bet_pro_all("differ3")
    ...
    def test_07_CAK3_pro_normal_same2_singleChoice_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_08_CAK3_pro_normal_same2_singleChoice_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "same2", "singleChoice")
    ...
    def test_09_CAK3_pro_normal_differ2_double_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_CAK3_pro_normal_differ2_smart_tracking(self):
        page_quick3 = GamePageQuick3(self.driver)
        page_quick3.switch_pro_game("normal", "differ2")
        # page_quick3.bet_pro_all("differ2")
