...
class Lottery1_TwoSide(unittest.TestCase):  # 一分彩 QAT/STG環境任選主玩法為關閉
    ...
    def test_44_Lottery1_twoSide_firstBall(self):
    ...
    def test_45_Lottery1_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_Lottery1_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_Lottery1_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_Lottery1_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_Lottery1_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_50_Lottery1_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_51_Lottery1_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_Lottery1_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_Lottery1_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_Lottery1_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_Lottery1_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
