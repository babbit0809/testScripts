...
class CARacing_TwoSide(unittest.TestCase):
    ...
    def test_10_CARacing_twoSide_twoface(self):
    ...
    def test_11_CARacing_twoSide_combination1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_12_CARacing_twoSide_sum1and2(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_13_CARacing_twoSide_firsttotenth(self):
        page_pk10 = GamePagePK10(self.driver)
