...
class XYFT_Pro(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("PK10", "xyft")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_XYFT_pro_normal_guess1(self):
    ...
    def test_02_XYFT_pro_normal_guess12(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_03_XYFT_pro_normal_guess123(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_04_XYFT_pro_normal_firstToTenth(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_05_XYFT_pro_fun_eat1(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_06_XYFT_pro_fun_bet3(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_07_XYFT_pro_fun_eat3(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_08_XYFT_pro_fun_positionQ(self):
        page_pk10 = GamePagePK10(self.driver)
    ...
    def test_09_XYFT_pro_fun_winningStreak(self):
        page_pk10 = GamePagePK10(self.driver)
