...
class SKK3_Pro(unittest.TestCase):
    ...
    def test_01_SKK3_pro_normal_sum(self):
    ...
    def test_02_SKK3_pro_normal_continuous3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_03_SKK3_pro_normal_same3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_SKK3_pro_normal_differ3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_05_SKK3_pro_normal_same2_singleChoice(self):
        bet_case = (
    ...
    def test_06_SKK3_pro_normal_same2_multiChoices(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_07_SKK3_pro_normal_differ2(self):
        page_quick3 = GamePageQuick3(self.driver)
