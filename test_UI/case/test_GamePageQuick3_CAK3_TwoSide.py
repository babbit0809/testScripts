...
class CAK3_TwoSide(unittest.TestCase):
    ...
    def test_08_CAK3_twoSide_army3(self):
    ...
    def test_09_CAK3_twoSide_fast3Sum(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_CAK3_twoSide_point(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_11_CAK3_twoSide_triple(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_12_CAK3_twoSide_long(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_13_CAK3_twoSide_short(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_14_CAK3_twoSide_fishShrimpCrab(self):
        page_quick3 = GamePageQuick3(self.driver)
