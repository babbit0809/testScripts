...
class TWK3_Pro(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("Quick3", "twk3")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_TWK3_pro_normal_sum(self):
    ...
    def test_02_TWK3_pro_normal_continuous3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_03_TWK3_pro_normal_same3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_04_TWK3_pro_normal_differ3(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_05_TWK3_pro_normal_same2_singleChoice(self):
        bet_case = (
    ...
    def test_06_TWK3_pro_normal_same2_multiChoices(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_07_TWK3_pro_normal_differ2(self):
        page_quick3 = GamePageQuick3(self.driver)
