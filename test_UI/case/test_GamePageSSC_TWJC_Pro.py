...
class TWJC_Pro(unittest.TestCase):  # 台灣時時彩 QAT/STG環境任選主玩法為關閉
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("SSC", "twjc")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_TWJC_pro_normal_fiveStar_fiveStarDirectSelection(self):
    ...
    def test_02_TWJC_pro_normal_fiveStar_fiveStarOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_03_TWJC_pro_normal_fiveStar_selection120(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_04_TWJC_pro_normal_fiveStar_selection60(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_05_TWJC_pro_normal_fiveStar_selection30(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_06_TWJC_pro_normal_fiveStar_selection20(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_07_TWJC_pro_normal_fiveStar_selection10(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_08_TWJC_pro_normal_fiveStar_selection5(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_09_TWJC_pro_normal_threeStar_front3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_10_TWJC_pro_normal_threeStar_front3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_11_TWJC_pro_normal_threeStar_middle3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_12_TWJC_pro_normal_threeStar_middle3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_13_TWJC_pro_normal_threeStar_back3Choice(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_14_TWJC_pro_normal_threeStar_back3Order(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_15_TWJC_pro_normal_threeStar_front3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_16_TWJC_pro_normal_threeStar_middle3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_17_TWJC_pro_normal_threeStar_back3Mix(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_18_TWJC_pro_normal_threeStarGroup3_front3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_19_TWJC_pro_normal_threeStarGroup3_middle3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_20_TWJC_pro_normal_threeStarGroup3_back3Group3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_21_TWJC_pro_normal_threeStarGroup6_front3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_22_TWJC_pro_normal_threeStarGroup6_middle3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_23_TWJC_pro_normal_threeStarGroup6_back3Group6(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_24_TWJC_pro_normal_twoStar_frontDirect(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_25_TWJC_pro_normal_twoStar_frontGroup(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_26_TWJC_pro_normal_twoStar_frontOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_27_TWJC_pro_normal_twoStar_backDirect(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_28_TWJC_pro_normal_twoStar_backGroup(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_29_TWJC_pro_normal_twoStar_backOrder(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_30_TWJC_pro_normal_dingweidan(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_31_TWJC_pro_normal_budingweidan_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_32_TWJC_pro_normal_budingweidan_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_33_TWJC_pro_normal_budingweidan_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_34_TWJC_pro_normal_bigSmallOddEven(self):
        page_ssc = GamePageSSC(self.driver)
