...
class JS11x5_TwoSide(unittest.TestCase):
    ...
    def test_43_JS11x5_twoSide_firstBall(self):
    ...
    def test_44_JS11x5_twoSide_secondBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_45_JS11x5_twoSide_thirdBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_46_JS11x5_twoSide_fourthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_47_JS11x5_twoSide_fifthBall(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_48_JS11x5_twoSide_total(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_49_JS11x5_twoSide_dragon(self):
        page_11x5 = GamePage11x5(self.driver)
    ...
    def test_50_JS11x5_twoSide_tiger(self):
        page_11x5 = GamePage11x5(self.driver)
