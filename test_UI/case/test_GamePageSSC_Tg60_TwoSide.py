...
class Tg60_TwoSide(unittest.TestCase):
    ...
    def test_44_Tg60_twoSide_firstBall(self):
    ...
    def test_45_Tg60_twoSide_secondBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_Tg60_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_Tg60_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_Tg60_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_Tg60_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_50_Tg60_twoSide_front3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_51_Tg60_twoSide_middle3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_Tg60_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_Tg60_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_Tg60_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_Tg60_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
