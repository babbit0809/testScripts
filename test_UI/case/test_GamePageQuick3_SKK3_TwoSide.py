...
class SKK3_TwoSide(unittest.TestCase):
    ...
    def test_08_SKK3_twoSide_army3(self):
    ...
    def test_09_SKK3_twoSide_fast3Sum(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_10_SKK3_twoSide_point(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_11_SKK3_twoSide_triple(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_12_SKK3_twoSide_long(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_13_SKK3_twoSide_short(self):
        page_quick3 = GamePageQuick3(self.driver)
    ...
    def test_14_SKK3_twoSide_fishShrimpCrab(self):
        page_quick3 = GamePageQuick3(self.driver)
