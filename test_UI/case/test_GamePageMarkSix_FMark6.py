...
class FMark6(unittest.TestCase):  # 六合彩沒有分官方盤/雙面盤(亦無常規/趣味之分)
    ...
    def setUpClass(cls):
        ...
        cls.game_name = game_page.switch_game("MarkSix", "fmark6")
        cls.OrderInfoTrace_No = Localization.get_loc("GamePage_Common", 'OrderInfoTrace_No')

    def test_01_FMark6_pro_normal_specialNo(self):
    ...
    def test_02_FMark6_pro_normal_mainNo(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_03_FMark6_pro_normal_main1to6_main1st(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_04_FMark6_pro_normal_main1to6_main2nd(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_05_FMark6_pro_normal_main1to6_main3rd(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_06_FMark6_pro_normal_main1to6_main4th(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_07_FMark6_pro_normal_main1to6_main5th(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_08_FMark6_pro_normal_main1to6_main6th(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_09_FMark6_pro_normal_mainSpecial_main1Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_10_FMark6_pro_normal_mainSpecial_main2Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_11_FMark6_pro_normal_mainSpecial_main3Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_12_FMark6_pro_normal_mainSpecial_main4Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_13_FMark6_pro_normal_mainSpecial_main5Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_14_FMark6_pro_normal_mainSpecial_main6Special(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    # def test_15_FMark6_pro_normal_multiNo_bet3Winning3(self):
    #     bet_case = (
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_16_FMark6_pro_normal_multiNo_bet3Winning2(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("multiNoCase1", "1-10"),
    #         ("multiNoCase2", "11-20"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_17_FMark6_pro_normal_multiNo_bet2Winning2(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("multiNoCase1", "1-10"),
    #         ("multiNoCase2", "11-20"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_18_FMark6_pro_normal_multiNo_bet2WinningSpecial(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("multiNoCase1", "1-10"),
    #         ("multiNoCase2", "11-20"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_19_FMark6_pro_normal_multiNo_bet2WinningMix(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("multiNoCase1", "1-10"),
    #         ("multiNoCase2", "11-20"),
    ...
    def test_20_FMark6_pro_normal_halfBall(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_21_FMark6_pro_normal_tailNo(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    # def test_22_FMark6_pro_normal_notWinning_notWinning5(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("notWinningCase1", "1-8"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_23_FMark6_pro_normal_notWinning_notWinning6(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("notWinningCase1", "1-8"),
    #         ("notWinningCase2", "9-16"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_24_FMark6_pro_normal_notWinning_notWinning7(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_25_FMark6_pro_normal_notWinning_notWinning8(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("notWinningCase1", "1-10"),
    #         ("notWinningCase2", "11-20"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_26_FMark6_pro_normal_notWinning_notWinning9(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("notWinningCase1", "1-10"),
    #         ("notWinningCase2", "11-20"),
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_27_FMark6_pro_normal_notWinning_notWinning10(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("notWinningCase1", "1-10"),
    #         ("notWinningCase2", "11-20"),
    ...
    def test_28_FMark6_pro_normal_zodiac1(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    def test_29_FMark6_pro_normal_specialZodiac(self):
        page_markSix = GamePageMarkSix(self.driver)
    ...
    # def test_30_FMark6_pro_normal_zodiac6_zodiac6Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiac6Case1", "鼠-蛇"),
    #         ("zodiac6Case2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_31_FMark6_pro_normal_zodiac6_zodiac6Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiac6Case1", "鼠-蛇"),
    #         ("zodiac6Case2", "馬-豬")
    ...
    # def test_32_FMark6_pro_normal_zodiacs_zodiac2Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_33_FMark6_pro_normal_zodiacs_zodiac2Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_34_FMark6_pro_normal_zodiacs_zodiac3Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_35_FMark6_pro_normal_zodiacs_zodiac3Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_36_FMark6_pro_normal_zodiacs_zodiac4Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_37_FMark6_pro_normal_zodiacs_zodiac4Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("zodiacsCase1", "鼠-蛇"),
    #         ("zodiacsCase2", "馬-豬")
    ...
    # def test_38_FMark6_pro_normal_tails_tail2Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_39_FMark6_pro_normal_tails_tail2Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_40_FMark6_pro_normal_tails_tail3Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_41_FMark6_pro_normal_tails_tail3Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_42_FMark6_pro_normal_tails_tail4Winning(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    #             Assertion.assertOrderInfo(expect_data, order_info_confirm, order_info_done)
    #
    # def test_43_FMark6_pro_normal_tails_tail4Lose(self):
    #     bet_case = (
    #         # A tuple of (params_value, subTest_description)
    #         ("tailsCase1", "0尾-4尾"),
    #         ("tailsCase2", "5尾-9尾")
    ...
    def test_44_FMark6_pro_normal_dt16(self):
        page_markSix = GamePageMarkSix(self.driver)
