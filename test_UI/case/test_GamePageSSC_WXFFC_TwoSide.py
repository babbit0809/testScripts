...
class WXFFC_TwoSide(unittest.TestCase):  # 微信分分彩 QAT/STG環境無五星玩法且任選主玩法為關閉, 另子玩法開關狀況如下
    ...
    # def test_44_WXFFC_twoSide_firstBall(self):
    ...
    # def test_45_WXFFC_twoSide_secondBall(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_46_WXFFC_twoSide_thirdBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_47_WXFFC_twoSide_fourthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_48_WXFFC_twoSide_fifthBall(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_49_WXFFC_twoSide_total(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    # def test_50_WXFFC_twoSide_front3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    # def test_51_WXFFC_twoSide_middle3(self):
    #     page_ssc = GamePageSSC(self.driver)
    ...
    def test_52_WXFFC_twoSide_back3(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_53_WXFFC_twoSide_dragon(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_54_WXFFC_twoSide_tiger(self):
        page_ssc = GamePageSSC(self.driver)
    ...
    def test_55_WXFFC_twoSide_equal(self):
        page_ssc = GamePageSSC(self.driver)
